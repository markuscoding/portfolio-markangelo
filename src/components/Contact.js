    ...
    <>
      ...
      >
        ...
        >
          ...
          <input
            className="p-2 bg-transparent text-white placeholder-white text-xl border border-solid rounded-xl border-b-gray-300 "
            type="text"
            placeholder="Name"
            name="name"
          />
          <input
            className=" my-2 p-2 bg-transparent text-white placeholder-white text-xl border border-solid rounded-xl border-b-gray-300"
            type="email"
            placeholder="Email"
            name="email"
          />
